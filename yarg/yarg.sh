...
wget -q -O $pro/$appname/extra/icon.png https://github.com/YARC-Official/YARG/raw/master/Images/Logo_White.png; chmod a+x $dep/tput; cd ~/
# --------------------------------------------------------------------
# // end of dependencies 
#
# --------------------------------------------------------------------
...
# --------------------------------------------------------------------
# -- prepare Ports file, 
port="/userdata/roms/ports/yarg.sh" 
rm "$port" 2>/dev/null
echo '#!/bin/bash ' >> $port
echo 'killall -9 yarg' >> $port
